...
filename = 'data/TeamQuestions.csv'
types = ['num:avgpointdiff', 'num:defqual', 'num:numlosses', 'num:numties', 'num:numwins', 'num:offqual', 'num:pointdiff', 'num:pointsagainst', 'num:pointsfor', 'num:schedtoughness', 'num:teamqual', 'num:winpercent']
...
model.save('team_lstm.h5')
#tf.keras.models.save_model(model, 'qa_g_lstm.h5')
tokenizer_json = tokenizer.to_json()
with open('team_tok.json', 'w', encoding='utf-8') as f:
